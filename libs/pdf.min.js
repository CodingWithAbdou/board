...
!function webpackUniversalModuleDefinition(e, t) {
    ...
    return (()=>{
        ...
        var __webpack_modules__ = [, (e,t,r)=>{
            ...
            t.addLinkAttributes = function addLinkAttributes(e, {url: t, target: r, rel: n, enabled: o=!0}={}) {
                (0,
                s.assert)(t && "string" == typeof t, 'addLinkAttributes: A valid "url" parameter must provided.');
                const l = (0,
                s.removeNullCharacters)(t);
                if (o)
                    e.href = e.title = l;
                else {
                    e.href = "";
            ...
            t.getPdfFilenameFromUrl = function getPdfFilenameFromUrl(e, t="document.pdf") {
                ...
                if (isDataScheme(e)) {
                    (0,
                    s.warn)('getPdfFilenameFromUrl: ignore "data:"-URL for performance reasons.');
                    return t
                }
            ...
            ;
            t.getXfaPageViewport = function getXfaPageViewport(e, {scale: t=1, rotation: r=0}) {
            ...
            ;
            t.StatTimer = t.RenderingCancelledException = t.PDFDateString = t.PageViewport = t.LinkTarget = t.DOMSVGFactory = t.DOMStandardFontDataFactory = t.DOMCMapReaderFactory = t.DOMCanvasFactory = t.DEFAULT_LINK_REL = void 0;
            var s = r(2)
              , n = r(5);
                    ...
                    a.onreadystatechange = ()=>{
                        if (a.readyState === XMLHttpRequest.DONE) {
                            if (200 === a.status || 0 === a.status) {
                                ...
                                s.stringToBytes)(a.responseText));
                                if (e) {
                                    r(e);
                                    return
                                }
            ...
            class PageViewport {
                constructor({viewBox: e, scale: t, rotation: r, offsetX: s=0, offsetY: n=0, dontFlip: a=!1}) {
                    this.viewBox = e;
                    this.scale = t;
                    this.rotation = r;
                    this.offsetX = s;
                ...
                clone({scale: e=this.scale, rotation: t=this.rotation, offsetX: r=this.offsetX, offsetY: s=this.offsetY, dontFlip: n=!1}={}) {
                    return new PageViewport({
            ...
            t.StatTimer = class StatTimer {
                ...
                time(e) {
                    e in this.started && (0,
                    s.warn)(`Timer is already running for ${e}`);
                    this.started[e] = Date.now()
                }
                timeEnd(e) {
                    e in this.started || (0,
                    s.warn)(`Timer has not been started for ${e}`);
                    this.times.push({
                        name: e,
        ...
        , (e,t,r)=>{
            ...
            t.createObjectURL = function createObjectURL(e, t="", r=!1) {
                ...
                for (let t = 0, r = e.length; t < r; t += 3) {
                    const a = 255 & e[t]
                      , i = 255 & e[t + 1]
                      , o = 255 & e[t + 2];
                    n += s[a >> 2] + s[(3 & a) << 4 | i >> 4] + s[t + 1 < r ? (15 & i) << 2 | o >> 6 : 64] + s[t + 2 < r ? 63 & o : 64]
                }
                return n
            }
            ;
            ...
            t.stringToPDFString = function stringToPDFString(e) {
                ...
                if ("þ" === e[0] && "ÿ" === e[1])
                    for (let s = 2; s < t; s += 2)
                        r.push(String.fromCharCode(e.charCodeAt(s) << 8 | e.charCodeAt(s + 1)));
                else if ("ÿ" === e[0] && "þ" === e[1])
                    for (let s = 2; s < t; s += 2)
                        r.push(String.fromCharCode(e.charCodeAt(s + 1) << 8 | e.charCodeAt(s)));
                else
                    for (let s = 0; s < t; ++s) {
            ...
            class Util {
                ...
                static getAxialAlignedBoundingBox(e, t) {
                    ...
                    return [Math.min(r[0], s[0], n[0], a[0]), Math.min(r[1], s[1], n[1], a[1]), Math.max(r[0], s[0], n[0], a[0]), Math.max(r[1], s[1], n[1], a[1])]
                }
                ...
                static intersect(e, t) {
                    ...
                    n[0] = r[1];
                    n[2] = r[2];
                    if (!(s[0] === e[1] && s[1] === t[1] || s[0] === t[1] && s[1] === e[1]))
                        return null;
                    n[1] = s[1];
                    n[3] = s[2];
                    return n
            ...
            class BaseCMapReaderFactory {
                ...
                async fetch({name: e}) {
                    ...
                    const t = this.baseUrl + e + (this.isCompressed ? ".bcmap" : "")
                      , r = this.isCompressed ? s.CMapCompressionType.BINARY : s.CMapCompressionType.NONE;
        ...
        , (__unused_webpack_module,exports,__w_pdfjs_require__)=>{
            ...
            function getDocument(e) {
                ...
                s.CMapReaderFactory = s.CMapReaderFactory || DefaultCMapReaderFactory;
                s.StandardFontDataFactory = s.StandardFontDataFactory || DefaultStandardFontDataFactory;
                s.ignoreErrors = !0 !== s.stopAtErrors;
                s.fontExtraProperties = !0 === s.fontExtraProperties;
                s.pdfBug = !0 === s.pdfBug;
                s.enableXfa = !0 === s.enableXfa;
                ("string" != typeof s.docBaseUrl || (0,
                _display_utils.isDataScheme)(s.docBaseUrl)) && (s.docBaseUrl = null);
                Number.isInteger(s.maxImageSize) || (s.maxImageSize = -1);
                "boolean" != typeof s.useWorkerFetch && (s.useWorkerFetch = s.CMapReaderFactory === _display_utils.DOMCMapReaderFactory && s.StandardFontDataFactory === _display_utils.DOMStandardFontDataFactory);
                "boolean" != typeof s.isEvalSupported && (s.isEvalSupported = !0);
                "boolean" != typeof s.disableFontFace && (s.disableFontFace = _is_node.isNodeJS);
                "boolean" != typeof s.useSystemFonts && (s.useSystemFonts = !_is_node.isNodeJS && !s.disableFontFace);
                void 0 === s.ownerDocument && (s.ownerDocument = globalThis.document);
                ...
                (0,
                _util.setVerbosityLevel)(s.verbosity);
                if (!a) {
                    const e = {
                ...
                a.promise.then((function() {
                    ...
                    const e = _fetchDocument(a, s, n, i)
                      , r = new Promise((function(e) {
                        ...
                        },n) : s.data || (t = createPDFNetworkStream({
                            url: s.url,
                            length: s.length,
            ...
            class PDFPageProxy {
                ...
                getViewport({scale: e, rotation: t=this.rotate, offsetX: r=0, offsetY: s=0, dontFlip: n=!1}={}) {
                ...
                render({canvasContext: e, viewport: t, intent: r="display", renderInteractiveForms: s=!1, transform: n=null, imageLayer: a=null, canvasFactory: i=null, background: o=null, includeAnnotationStorage: l=!1, optionalContentConfigPromise: c=null}) {
                    var h;
                    ...
                    const p = i || new DefaultCanvasFactory({
                    ...
                    const m = f.task;
                    Promise.all([u.displayReadyCapability.promise, c]).then((([e,t])=>{
                ...
                getOperatorList({intent: e="display"}={}) {
                    ...
                    let r, s = this._intentStates.get(t);
                    if (!s) {
                ...
                streamTextContent({normalizeWhitespace: e=!1, disableCombineTextItems: t=!1, includeMarkedContent: r=!1}={}) {
                    ...
                    const r = new WeakMap
                      , s = {
                        data: function cloneValue(e) {
                            ...
                            let s, n;
                            if ((s = e.buffer) && (0,
                            _util.isArrayBuffer)(s)) {
                                n = t?.includes(s) ? new e.constructor(s,e.byteOffset,e.byteLength) : new e.constructor(e);
                                r.set(e, n);
                                return n
                            }
                            if (e instanceof Map) {
                            ...
                            for (const t in e) {
                                ...
                                void 0 !== r.value && (("function" != typeof r.value || e.hasOwnProperty?.(t)) && (n[t] = cloneValue(r.value)))
                            }
                            return n
                        }(e)
                    };
                    ...
                    _setupFakeWorker() {
                        ...
                        setupFakeWorkerGlobal().then((e=>{
                            ...
                            const r = "fake" + nextFakeWorkerId++
                              , s = new _message_handler.MessageHandler(r + "_worker",r,t);
                            e.setup(s, t);
            ...
            const InternalRenderTask = function InternalRenderTaskClosure() {
                ...
                return class InternalRenderTask {
                    constructor({callback: e, params: t, objs: r, commonObjs: s, operatorList: n, pageIndex: a, canvasFactory: i, useRequestAnimationFrame: o=!1, pdfBug: l=!1}) {
                        this.callback = e;
                        this.params = t;
                        this.objs = r;
                        this.commonObjs = s;
                    ...
                    initializeGraphics({transparency: t=!1, optionalContentConfig: r}) {
                        ...
                        const {canvasContext: s, viewport: n, transform: a, imageLayer: i, background: o} = this.params;
        ...
        , (e,t,r)=>{
            ...
            class BaseFontLoader {
                constructor({docId: e, onUnsupportedFeature: t, ownerDocument: r=globalThis.document, styleElement: n=null}) {
                    this.constructor === BaseFontLoader && (0,
                    s.unreachable)("Cannot initialize BaseFontLoader.");
                    this.docId = e;
                    ...
                    if (this.isFontLoadingAPISupported) {
                        ...
                        if (t) {
                            ...
                            try {
                                ...
                                (0,
                                s.warn)(`Failed to load font '${t.family}': '${r}'.`);
                                e.disableFontFace = !0;
                                throw r
                            }
                        }
                ...
                _queueLoadingCallback(e) {
                    (0,
                    s.unreachable)("Abstract method `_queueLoadingCallback`.")
                }
                get isFontLoadingAPISupported() {
                    const e = !!this._document?.fonts;
                    return (0,
                    s.shadow)(this, "isFontLoadingAPISupported", e)
                }
                get isSyncFontLoadingSupported() {
                    (0,
                    s.unreachable)("Abstract method `isSyncFontLoadingSupported`.")
                }
                get _loadTestFont() {
                    (0,
                    s.unreachable)("Abstract method `_loadTestFont`.")
                }
                _prepareFontLoadEvent(e, t, r) {
                    (0,
                    s.unreachable)("Abstract method `_prepareFontLoadEvent`.")
                }
            }
            let n;
            t.FontLoader = n;
            t.FontLoader = n = class GenericFontLoader extends BaseFontLoader {
                ...
                get isSyncFontLoadingSupported() {
                    ...
                    return (0,
                    s.shadow)(this, "isSyncFontLoadingSupported", e)
                }
                _queueLoadingCallback(e) {
                    const t = this.loadingContext
                      , r = {
                        ...
                        complete: function completeRequest() {
                            (0,
                            s.assert)(!r.done, "completeRequest() cannot be called twice.");
                            r.done = !0;
            ...
            t.FontFaceObject = class FontFaceObject {
                constructor(e, {isEvalSupported: t=!0, disableFontFace: r=!1, ignoreErrors: s=!1, onUnsupportedFeature: n, fontRegistry: a=null}) {
                ...
                getPathGenerator(e, t) {
                    ...
                    try {
                        ...
                        (0,
                        s.warn)(`getPathGenerator - ignoring character: "${e}".`);
        ...
        , (e,t,r)=>{
            ...
            t.AnnotationStorage = class AnnotationStorage {
                ...
                getAll() {
                    ...
                    s.objectFromMap)(this._storage) : null
                }
                get size() {
        ...
        , (e,t,r)=>{
            ...
            function addContextCurrentTransform(e) {
                if (!e.mozCurrentTransform) {
                    ...
                    Object.defineProperty(e, "mozCurrentTransformInverse", {
                        get: function getCurrentTransformInverse() {
                            const [e,t,r,s,n,a] = this._transformMatrix
                              , i = e * s - t * r
                              , o = t * r - e * s;
                            return [s / i, t / o, r / o, e / i, (s * n - r * a) / o, (t * n - e * a) / i]
                        }
                    });
                    ...
                    e.transform = function ctxTransform(t, r, s, n, a, i) {
                        ...
                        this._transformMatrix = [o[0] * t + o[2] * r, o[1] * t + o[3] * r, o[0] * s + o[2] * n, o[1] * s + o[3] * n, o[0] * a + o[2] * i + o[4], o[1] * a + o[3] * i + o[5]];
            ...
            const o = function CanvasGraphicsClosure() {
                ...
                class CanvasGraphics {
                    ...
                    beginDrawing({transform: e, viewport: t, transparency: r=!1, background: s=null}) {
                    ...
                    _scaleImage(e, t) {
                        const r = e.width
                          , s = e.height;
                        let n, a, i = Math.max(Math.hypot(t[0], t[1]), 1), o = Math.max(Math.hypot(t[2], t[3]), 1), l = r, c = s, h = "prescale1";
                        for (; i > 2 && l > 1 || o > 2 && c > 1; ) {
                            let t = l
                              , r = c;
                            if (i > 2 && l > 1) {
                    ...
                    _createMaskCanvas(e) {
                        ...
                        const y = s.Util.transform(m.mozCurrentTransformInverse, [1, 0, 0, 1, -A, -_]);
                    ...
                    suspendSMaskGroup() {
                        ...
                        const t = s.Util.transform(this.current.activeSMask.startTransformInverse, e.mozCurrentTransform);
                    ...
                    setFont(e, t) {
                        ...
                        s.warn)("Invalid font matrix for font " + e);
                        if (t < 0) {
                            t = -t;
                            n.fontDirection = -1
                        } else
                    ...
                    get isFontSubpixelAAEnabled() {
                        ...
                        return (0,
                        s.shadow)(this, "isFontSubpixelAAEnabled", r)
                    }
                    showText(e) {
                        ...
                        const a = this.ctx
                          ...
                          , g = r.defaultVMetrics
                          , f = n * t.fontMatrix[0]
                          , m = t.textRenderingMode === s.TextRenderingMode.FILL && !r.disableFontFace && !t.patternFill;
                        a.save();
                        let A;
                        if (t.patternFill) {
                            a.save();
                        ...
                        if (0 === y || 0 === _) {
                            ...
                            if (e === s.TextRenderingMode.STROKE || e === s.TextRenderingMode.FILL_STROKE) {
                                this._cachedGetSinglePixelWidth = null;
                    ...
                    showType3Text(e) {
                        const t = this.ctx
                          ...
                          , u = e.length;
                        let p, g, f, m;
                        if (!(r.textRenderingMode === s.TextRenderingMode.INVISIBLE) && 0 !== a) {
                            this._cachedGetSinglePixelWidth = null;
                            t.save();
                    ...
                    getColorN_Pattern(e) {
                        ...
                        if ("TilingPattern" === e[0]) {
                            const r = e[1]
                              , s = this.baseTransform || this.ctx.mozCurrentTransform.slice()
                              , a = {
                    ...
                    _getPattern(e) {
                        ...
                        const t = (0,
                        n.getShadingPattern)(this.objs.get(e));
                    ...
                    beginGroup(e) {
                        ...
                        let n = s.Util.getAxialAlignedBoundingBox(e.bbox, t.mozCurrentTransform);
                    ...
                    paintImageMaskXObject(e) {
                        ...
                        n && void 0 === n.compiled && (n.compiled = r <= 1e3 && s <= 1e3 ? function compileType3Glyph(e) {
                    ...
                    paintInlineImageXObject(e) {
                        ...
                        s.drawImage(a.img, 0, 0, a.paintWidth, a.paintHeight, 0, -r, t, r);
                        if (this.imageLayer) {
                    ...
                    getSinglePixelWidth() {
                        if (null === this._cachedGetSinglePixelWidth) {
                            ...
                            r !== s && this._combinedScaleFactor * n > 1 ? this._cachedGetSinglePixelWidth = -this._combinedScaleFactor * n : t > Number.EPSILON ? this._cachedGetSinglePixelWidth = n : this._cachedGetSinglePixelWidth = 1
                        }
        ...
        , (e,t,r)=>{
                ...
                getPattern(e, t, r, n=!1) {
                    ...
                    if (this._patternCache)
                        ...
                        if (n) {
                            ...
                            const r = t.cachedCanvases.getCanvas("pattern", t.ctx.canvas.width, t.ctx.canvas.height, !0)
                              , s = r.context;
            ...
            function drawFigure(e, t, r) {
                ...
                case "lattice":
                    ...
                    for (a = 0; a < l; a++) {
                        ...
                        for (let a = 0; a < c; a++,
                        t++) {
                            drawTriangle(e, r, s[t], s[t + 1], s[t + o], n[t], n[t + 1], n[t + o]);
                            drawTriangle(e, r, s[t + o + 1], s[t + 1], s[t + o], n[t + o + 1], n[t + 1], n[t + o])
                        }
                    }
                    break;
                case "triangles":
            ...
            class TilingPattern {
                static get MAX_PATTERN_SIZE() {
                    return (0,
                    s.shadow)(this, "MAX_PATTERN_SIZE", 3e3)
                }
        ...
        , (e,t,r)=>{
            ...
            t.MessageHandler = class MessageHandler {
                constructor(e, t, r) {
                    ...
                    this._onComObjOnMessage = e=>{
                        ...
                        if (t.callbackId) {
                            ...
                            t.streamId ? this._createStreamSink(t) : s(t.data)
                    }
                    ;
                ...
                _processStreamMessage(e) {
                    ...
                    case c:
                        (0,
                        s.assert)(this.streamControllers[t], "enqueue should have stream controller");
                    ...
                    case l:
                        (0,
                        s.assert)(this.streamControllers[t], "close should have stream controller");
                        if (this.streamControllers[t].isClosed)
                            break;
                    ...
                    case h:
                        (0,
                        s.assert)(this.streamControllers[t], "error should have stream controller");
        ...
        , (e,t,r)=>{
            ...
            t.OptionalContentConfig = class OptionalContentConfig {
                ...
                isVisible(e) {
                    if ("OCG" === e.type) {
                        if (!this._groups.has(e.id)) {
                            (0,
                            s.warn)(`Optional content group not found: ${e.id}`);
                            return !0
                        }
                ...
                getGroups() {
                    ...
                    s.objectFromMap)(this._groups) : null
                }
                getGroup(e) {
        ...
        , (e,t,r)=>{
            ...
            class AnnotationElement {
                constructor(e, {isRenderable: t=!1, ignoreBorder: r=!1, createQuadrilaterals: s=!1}={}) {
                    this.isRenderable = t;
                    this.data = e.data;
                    this.layer = e.layer;
                    this.page = e.page;
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    e.url ? (0,
                    s.addLinkAttributes)(r, {
                        url: e.url,
                        target: e.newWindow ? s.LinkTarget.BLANK : t.externalLinkTarget,
            ...
            class WidgetAnnotationElement extends AnnotationElement {
                ...
                _setEventListeners(e, t, r) {
                    for (const [s,n] of t)
                        ("Action" === n || this.data.actions?.[n]) && this._setEventListener(e, s, n, r)
                }
                _dispatchEventFromSandbox(e, t) {
                    const setColor = (e,t,r)=>{
                        const s = r.detail[e];
                        r.target.style[t] = i.ColorConverters[`${s[0]}_HTML`](s.slice(1))
                    }
                      , r = {
                        display: e=>{
                    ...
                    if (this.renderInteractiveForms) {
                        ...
                        if (this.enableScripting && this.hasJSActions) {
                            ...
                            this.data.actions?.Keystroke && r.addEventListener("input", (e=>{
                                let r = -1
                                  , s = -1;
                                a.beforeInputSelectionRange && ([r,s] = a.beforeInputSelectionRange);
                                this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
                                    source: this,
                                    detail: {
                                        id: t,
                ...
                render() {
                    ...
                    n.addEventListener("change", (function(t) {
                        ...
                        for (const t of document.getElementsByName(s.name))
                            t !== s && e.setValue(t.getAttribute("id"), {
                                value: !1
                            });
                        e.setValue(r, {
                            value: s.checked
                        ...
                        n.addEventListener("updatefromsandbox", (t=>{
                            const n = {
                                value(t) {
                                    ...
                                    for (const s of document.getElementsByName(t.target.name)) {
                        ...
                        r.addEventListener("updatefromsandbox", (s=>{
                            const n = {
                                ...
                                remove(s) {
                                    ...
                                    r.remove(a);
                                    if (n.length > 0) {
                                        -1 === Array.prototype.findIndex.call(n, (e=>e.selected)) && (n[0].selected = !0)
                                    }
                                    e.setValue(t, {
                                        value: getValue(s, !0),
                                        items: getItems(s)
                                ...
                                insert(s) {
                                    const {index: n, displayValue: a, exportValue: i} = s.detail.insert
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    const r = new PopupElement({
                      ...
                      , s = this.page
                      , a = n.Util.normalizeRect([this.data.parentRect[0], s.view[3] - this.data.parentRect[1] + s.view[1], this.data.parentRect[2], s.view[3] - this.data.parentRect[3] + s.view[1]])
                ...
                render() {
                    ...
                    if (r) {
                        const e = .7 * (255 - r[0]) + r[0]
                          , s = .7 * (255 - r[1]) + r[1]
                          , a = .7 * (255 - r[2]) + r[2];
                        t.style.backgroundColor = n.Util.makeHexColor(0 | e, 0 | s, 0 | a)
                    }
            ...
            class FileAttachmentAnnotationElement extends AnnotationElement {
                constructor(e) {
                    ...
                    this.filename = (0,
                    s.getFilenameFromUrl)(t);
                    this.content = r;
                    this.linkService.eventBus?.dispatch("fileattachmentannotation", {
                        source: this,
                        id: (0,
                        n.stringToPDFString)(t),
                        filename: t,
                        content: r
                    })
                }
            ...
            t.AnnotationLayer = class AnnotationLayer {
                static render(e) {
                    ...
                    for (const s of e.annotations)
                        s && (s.annotationType !== n.AnnotationType.POPUP ? t.push(s) : r.push(s));
                    r.length && t.push(...r);
                    for (const r of t) {
                        ...
                        if (t.isRenderable) {
                            ...
                            if (Array.isArray(s))
                                ...
                                t instanceof PopupAnnotationElement ? e.div.prepend(s) : e.div.appendChild(s)
                        }
                    }
                }
                static update(e) {
                    ...
                    for (const r of e.annotations) {
                        const s = e.div.querySelectorAll(`[data-annotation-id="${r.id}"]`);
                        if (s)
                            for (const e of s)
                                e.style.transform = t
                    }
        ...
        , (e,t,r)=>{
            ...
            function appendText(e, t, r, o) {
                ...
                A && (u.vertical ? c.canvasWidth = t.height * e._viewport.scale : c.canvasWidth = t.width * e._viewport.scale);
            ...
            function expandBoundsLTR(e, t) {
                ...
                for (const e of t) {
                    let t = 0;
                    for (; t < r.length && r[t].end <= e.y1; )
                        t++;
                    let s, n, a = r.length - 1;
                    for (; a >= 0 && r[a].start >= e.y2; )
                        a--;
                    let i, o, l = -1 / 0;
                    for (i = t; i <= a; i++) {
                        s = r[i];
            ...
            class TextLayerRenderTask {
                constructor({textContent: e, textContentStream: t, container: r, viewport: n, textDivs: a, textContentItemsStr: i, enhanceTextSelection: o}) {
                    this._textContent = e;
            ...
            t.SVGGraphics = i;
            {
                const e = {
                  ...
                  , h = function() {
                    ...
                    function encode(t, r, n, i) {
                        ...
                        return (0,
                        s.createObjectURL)(b, "image/png", n)
                    }
                    return function convertImgDataToPng(e, t, r) {
                        return encode(e, void 0 === e.kind ? s.ImageKind.GRAYSCALE_1BPP : e.kind, t, r)
                    }
                }();
                class SVGExtraState {
                    constructor() {
                ...
                t.SVGGraphics = i = class {
                    ...
                    showText(t) {
                        ...
                        const A = n.textRenderingMode & s.TextRenderingMode.FILL_STROKE_MASK;
                    ...
                    addFontStyle(e) {
                        ...
                        const t = (0,
                        s.createObjectURL)(e.data, e.mimetype, this.forceDataSchema);
                    ...
                    endText() {
                        const e = this.current;
                        if (e.textRenderingMode & s.TextRenderingMode.ADD_TO_PATH_FLAG && e.txtElement?.hasChildNodes()) {
                    ...
                    _makeTilingPattern(e) {
                        const t = e[1]
                          ...
                          , d = e[7]
                          , u = "shading" + p++
                          , [g,f,m,A] = s.Util.normalizeRect([...s.Util.applyTransform([a, i], n), ...s.Util.applyTransform([o, l], n)])
                    ...
                    constructPath(e, t) {
                        ...
                        for (const r of e)
                            ...
                            case s.OPS.rectangle:
                                ...
                                const e = n + t[o++]
                                  , r = a + t[o++];
                                i.push("M", pf(n), pf(a), "L", pf(e), pf(a), "L", pf(e), pf(r), "L", pf(n), pf(r), "Z");
                                break;
                            case s.OPS.moveTo:
                                n = t[o++];
                                a = t[o++];
                    ...
                    paintInlineImageXObject(e, t) {
                        ...
                        i.setAttributeNS(null, "transform", `scale(${pf(1 / r)} ${pf(-1 / s)})`);
            ...
            t.XfaLayer = class XfaLayer {
                    ...
                    case "select":
                        ...
                        e.addEventListener("input", (e=>{
                            const r = e.target.options
                              , n = -1 === r.selectedIndex ? "" : r[r.selectedIndex].value;
                            s.setValue(t, {
                                value: n
                            })
                        }
                ...
                static setAttributes(e, t, r, s) {
                    ...
                    for (const [t,r] of Object.entries(n))
                        null != r && "dataId" !== t && ("style" !== t ? "textContent" === t ? e.textContent = r : "class" === t ? e.setAttribute(t, r.join(" ")) : e.setAttribute(t, r) : Object.assign(e.style, r));
                ...
                static render(e) {
                    ...
                    for (; a.length > 0; ) {
                        ...
                        let l;
                        l = i?.attributes?.xmlns ? document.createElementNS(i.attributes.xmlns, o) : document.createElement(o);
                        n.appendChild(l);
                        i.attributes && this.setAttributes(l, i, t, s);
                        i.children && i.children.length > 0 ? a.push([i, -1, l]) : i.value && l.appendChild(document.createTextNode(i.value))
                    }
                    for (const e of i.querySelectorAll(".xfaNonInteractive input, .xfaNonInteractive textarea"))
        ...
        , (e,t,r)=>{
            ...
            class PDFNodeStreamFullReader extends BaseFullReader {
                constructor(e) {
                    ...
                    const handleResponse = t=>{
                        if (404 === t.statusCode) {
                            const e = new s.MissingPDFException(`Missing PDF "${this._url}".`);
                            this._storedError = e;
            ...
            class PDFNodeStreamFsRangeReader extends BaseRangeReader {
                constructor(e, t, r) {
                    ...
                    this._setReadableStream(a.createReadStream(s, {
                        start: t,
                        end: r - 1
                    }))
                }
        ...
        , (e,t,r)=>{
            ...
            t.createResponseStatusError = function createResponseStatusError(e, t) {
                ...
                return new s.UnexpectedResponseException(`Unexpected server response (${e}) while retrieving PDF "${t}".`,e)
            }
            ;
            ...
            ;
            t.validateRangeRequestCapabilities = function validateRangeRequestCapabilities({getResponseHeader: e, isHttp: t, rangeChunkSize: r, disableRange: n}) {
                (0,
            ...
            t.getFilenameFromContentDispositionHeader = function getFilenameFromContentDispositionHeader(e) {
                ...
                function rfc2047decode(e) {
                    return !e.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(e) ? e : e.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (function(e, t, r, s) {
                        if ("q" === r || "Q" === r)
                            return textdecode(t, s = (s = s.replace(/_/g, " ")).replace(/=([0-9a-fA-F]{2})/g, (function(e, t) {
        ...
        , (e,t,r)=>{
            ...
            class PDFNetworkStreamFullRequestReader {
                ...
                _onError(e) {
                    const t = this._url
                      , r = (0,
                    n.createResponseStatusError)(e, t);
                    this._storedError = r;
                ...
                constructor(e) {
                    ...
                    fetch(r, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((e=>{
                        ...
                        n.validateResponseStatus)(e.status))
                            throw (0,
                            n.createResponseStatusError)(e.status, r);
